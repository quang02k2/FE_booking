...
function header (){
    ...
    var authen = <a href="login" class="pointermenu gvs menulink"><i class="fa fa-user"></i> Register/Log in</a>
    if(token != null){
        ...
        <div id='menu'>
           <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand navbar-toggler" href="index"><img class="imglogo" src={logo2}/></a>
                    <span>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="linktop" href='index'><img class="imglogo" src={logo2}/></a></li>
                    ...
                    <div class="d-flex right10p">
                        <a href="tel:1900%201833" class="phonemenu"><i class="fa fa-phone"></i> 19001000</a>
                    </div>
                    <div class="d-flex">
