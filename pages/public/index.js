...
import image123 from '../../assest/images/image123.jpg'
import bannerdp from '../../assest/images/bannerdp.jpg'
      ...
      <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <a href="#"><img src={banner} class="d-block w-100 img-carousel"/></a>
            </div>
            <div class="carousel-item ">
                <a href="#"><img src={bannerdp} class="d-block w-100 img-carousel"/></a>
            </div>
            <div class="carousel-item ">
                <a href="#"><img src={image123} class="d-block w-100 img-carousel"/></a>
            </div>
        </div>
