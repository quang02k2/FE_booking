    ...
    return(
                ...
                <div class="col-sm-8">
                    ...
                    <div class="row" id="listRoom">
                        {items.map((item=>{
                            ...
                            <div class="col-4">
                                <img onClick={()=>setItem(item)} src={item.image} data-bs-toggle="modal" data-bs-target="#modaldeail" class="imgroom pointer"/>
                            </div>
                            <div class="col-8">
                                <div class="nameroomdiv">
                                    <span class="roomnames pointer">{item.name}</span>
                                    <span onClick={()=>setItem(item)} data-bs-toggle="modal" data-bs-target="#modaldeail" class="motaroom pointer">Xem mô tả & ảnh phòng</span>
                                </div>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
               <div dangerouslySetInnerHTML={{__html:item==null?'':item.description}}></div>
            </div>
            </div>
        </div>
        </div>
